...
public class LeafModel implements Model{
    private final Matrix4f modelMat;
    private final Mesh mesh;
    private final Uni<Matrix4f> modelMatLoc;

    public LeafModel(Mesh pMesh, Uni<Matrix4f> pModelMatLoc){//todo change that shit
    ...
    public void setRotation(float pitch, float yaw, float roll){
        modelMat.setRotationXYZ(pitch, yaw, roll);
    }
